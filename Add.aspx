<%@ Page Title="" Language="C#" MasterPageFile="~/Mobile.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="Add" %>

<%@ MasterType VirtualPath="Mobile.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Label runat="server" ID="lbl_success" Visible="False" CssClass="success_message">Your new reminder has been added!</asp:Label>
    <ul data-role="listview" data-inset="true">
        <li data-role="fieldcontain">
            <asp:Label runat="server" Text="Title" CssClass="form_label" AssociatedControlID="txt_title"></asp:Label>
        ...
        <li data-role="fieldcontain">
            <asp:Label runat="server" Text="Date" CssClass="form_label" AssociatedControlID="txt_date"></asp:Label>
            <asp:TextBox runat="server" ID="txt_date"></asp:TextBox>
            <ajax:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txt_date" Format="yyyy/MM/dd" />
        ...
        <li data-role="fieldcontain">
            <asp:Label runat="server" Text="Notes" CssClass="form_label" AssociatedControlID="txt_notes"></asp:Label>
            <asp:TextBox runat="server" ID="txt_notes" TextMode="MultiLine" Height="200px"></asp:TextBox>
        </li>
        <li data-role="fieldcontain">
            <asp:Label runat="server" Text="Categories" CssClass="form_label" AssociatedControlID="ddl_categories"></asp:Label>
        ...
        <li data-role="fieldcontain">
            <asp:Label runat="server" Text="Priority" CssClass="form_label" AssociatedControlID="rbl_priority"></asp:Label>
        ...
        <li class="ui-body ui-body-b">
            <div class="ui-grid-a">
                <div class="ui-block-a">
                    <asp:Button runat="server" CssClass="submit_button" CommandName="submit" ID="btn_submit" Text="Add" CausesValidation="True" OnClick="Button_Click" />
                </div>
                <div class="ui-block-b">
                    <asp:Button runat="server" ID="btn_reset" Text="Reset" CommandName="reset" OnClick="Button_Click" />
                </div>
            </div>
        </li>
